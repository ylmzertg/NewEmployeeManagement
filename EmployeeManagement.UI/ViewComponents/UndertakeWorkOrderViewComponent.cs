...
{
    public class UndertakeWorkOrderViewComponent : ViewComponent
    {
        #region Variables
        ...
        #region Constructor
        public UndertakeWorkOrderViewComponent(IUnitOfWork uow, IMapper mapper)
        {
            _uow = uow;
            _mapper = mapper;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int pageNumber = 1)
        {
            ...
            var workOrderStatus = (int)EnumWorkOrderStatus.Undertake;
